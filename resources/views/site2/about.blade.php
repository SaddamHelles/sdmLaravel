...
@section('content')
    ...
    <!-- About Section-->
    <section style="padding-top: 150px" class="page-section bg-primary text-white mb-0" id="about">
        <div class="container">
            <!-- About Section Heading-->
            <h2 class="page-section-heading text-center text-uppercase text-white">{{ $desc }}</h2>
            <!-- Icon Divider-->
